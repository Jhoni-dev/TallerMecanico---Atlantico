  ...
  return (
    <Label
      ...
      className={cn(
        ...
        "has-data-[state=checked]:bg-primary/5 has-data-[state=checked]:border-primary dark:has-data-[state=checked]:bg-primary/10 dark:has-data-[state=checked]:border-primary/60",
        className
      )}
      {...props}
    />
...
function FieldError({
  ...
  return (
    <div
      ...
      className={cn("text-destructive text-sm font-medium leading-normal", className)}
      {...props}
    >
      {content}
    </div>
